---
title: 'Simone Bærnthsen Game of Thrones'
...
### A word cloud of the most used words in GOT (non-numeric)

See more: https://cran.r-project.org/web/packages/ggwordcloud/vignettes/ggwordcloud.html

```{r wordcloud-prep}
# There are almost 12000 unique words 
...
Look back in the GOT.pdf, and search for "honor." Is it typically associated with emotion, or something else? 
...
#View()# Count to find the most excluded:
...
Wait, so "Honor" is showing up in NRC lexicon as more the a word with positive connotations? Let's check:
```{r nrc-confidence}
